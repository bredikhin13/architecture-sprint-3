...
![ER_diargram_1.png](diagrams/ER_diargram_1.png)

***Описание связей в ER диаграмме***
- Users <-> HomeSystems
  Связь: Многие-ко-многим (M:N)
  Один пользователь может быть владельцем или гостем в нескольких системах умного дома.
  Одна система умного дома может принадлежать нескольким пользователям (например, члены семьи).
  Реализация: Вводится промежуточная таблица UserHomeSystem с атрибутами user_id, home_system_id, role.
- HomeSystems -> Devices
